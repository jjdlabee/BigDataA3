...
| Filename | Source |
|----------|--------|
| `tlc_annual_report_2023.pdf` | nyc.gov/tlc |
| `tlc_factbook_2022.pdf` | nyc.gov/tlc |
| `dot_mobility_report_2023.pdf` | nyc.gov/dot |
| `congestion_pricing_impact.pdf` | mta.info |
| `tlc_driver_income_study.pdf` | nyc.gov/tlc |
| `ridesharing_labor_paper.pdf` | SSRN |
| `taxi_technology_report.pdf` | nyc.gov/tlc |
